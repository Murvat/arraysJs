...
const f1 = (): void => {
    a1_res = a1.map((item: number): number => item * 3);
    console.log(a1);
    console.log(a1_res);
};
...
a2[3] = 13;
a2[6] = 3;
let a2_res: (number | undefined)[];

const f2 = (): void => {
    a2_res = a2.map((item: number): number => item * 3);
    console.log(a2);
    console.log(a2_res);
};
...
const f3 = (): void => {
    a3_res = a3.map((item: number, index: number): number => {
        if (index === 2) {
            a3[3] = 100;
        }
        return item * 3;
...
let a4: number[] = [3, -2, 4, 1, 9, -3, 0, 0, 2, -8, 12];
let a4_res: number[];

const f4 = (): void => {
    a4_res = a4.map((item: number): number => {
...
const f5 = (): void => {
    a5_res = a5.map((item: number, index: number): number => index);
    console.log(a5);
    console.log(a5_res);
};
...
const f6 = (): void => {
    a6_res = a6.map((item: number, index: number): number => index);
    console.log(a6);
    console.log(a6_res);
};
...
const f7 = (): void => {
    a7_res = a7.map((item: number[]): number => item.length);
    console.log(a7);
    console.log(a7_res);
};
...
const f8 = (): void => {
    ...
    a8_res = a8.map((item: number[]): number => sum(item));
    console.log(a8);
    console.log(a8_res);
};
...
let a9: number[] = [22, 13, 45, 5, 2, 5, 3, 6, 7, 9];
let a9_index: number[];
let a9_even: number[];
...
const f9 = (): void => {
    a9_even = [];
    a9_index = [];
    a9.map((item: number, index: number): void => {
        if (item % 2 === 0) {
            a9_even.push(item);
        }
        a9_index.push(index);
...
const f10 = (arr: number[], fc: (elem: number) => number): number[] => {
    a10_res = [];
...
const callback10 = (elem: number): number => {
    return elem * 2;
};
