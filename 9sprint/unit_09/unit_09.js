...
const f1 = () => {
    ...
    document.querySelector('.out-1').textContent = res ? res : 'undefined';
...
const f2 = () => {
    ...
    document.querySelector('.out-2').textContent = res ? res : 'false'
...
const f3 = () => {
    a3_res = [];
    let arr = a3.filter(item => item > a3_from && item < a3_to)
    for (item of arr) {
        a3_res.push(item);
    }
...
const f4 = () => {
    let arr = str4.split(' ');
    let index_from = str4.indexOf(a4_from);
    let index_to = str4.indexOf(a4_to);
    let res = arr.find((item, index) => index > index_from && index < index_to)
    console.log(res)
    document.querySelector('.out-4').textContent = res ? res : 'undefined';
}
...
const f5 = () => {
    ...
    document.querySelector('.out-5').textContent = res ? res : -1
}
...
const f6 = () => {
    let from = a6.findIndex(item => item > a6_from && item < a6_to);
    let num = a6.find(item => item > a6_from && item < a6_to);

    let lastIndex = a6.lastIndexOf(num, from); document.querySelector('.out-6').textContent = lastIndex
}
...
const f7 = () => {
    ...
    document.querySelector('.out-7').textContent = res ? res : -1;
}
