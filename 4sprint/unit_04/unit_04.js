...
const f2 = () => {
    let inpurValue = +document.querySelector('.i-2').value;
    a2.unshift(inpurValue, inpurValue ** 3);
    console.log(a2);
    return a2;
...
const f3 = () => {
    ...
    // ваш код
    console.log(a3.unshift(inputValue));
    console.log(a3);
}
