...
const f1 = () => {
    ...
    document.querySelector('.out-1').textContent = a1.includes(inputValue)
}
...
const f2 = () => {
    ...
    if (a2.includes(inputValue)) {
        document.querySelector('.out-2').textContent = a2.indexOf(inputValue)
    } else {
...
const f4 = () => {
    let inputValue = Number(document.querySelector('.i-4').value);
    let out = ''
    for (let key in a4) {
...
const f5 = () => {
    ...
    let out = a5.includes(inputValue, inputFrom) ? true : false;
...
const f6 = () => {
    ...
    let out = a6.includes(inputValue) ? true : false;
...
const f9 = () => {
    ...
    let res = a9.includes(inputValue) || a9.includes(inputValue.toLowerCase()) || a9.includes(inputValue.toUpperCase()) || a9.includes(Number(inputValue))
